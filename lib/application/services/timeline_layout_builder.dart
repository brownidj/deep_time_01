...
class TimelineLayoutBuilder {
  TimelineLayoutSnapshot build(
    ...
    final layoutBuilder = _RightToLeftDivisionLayout(
      divisions: divisions,
...
class _RightToLeftDivisionLayout {
  _RightToLeftDivisionLayout({
...
class _DivisionLayoutResult {
  const _DivisionLayoutResult({

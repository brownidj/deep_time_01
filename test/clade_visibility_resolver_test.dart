...
void main() {
  ...
  test('zoom level mapping follows scale thresholds', () {
    ...
    expect(resolver.zoomLevelForScale(3.0), CladeZoomLevel.era);
    expect(resolver.zoomLevelForScale(4.0), CladeZoomLevel.period);
    expect(resolver.zoomLevelForScale(5.0), CladeZoomLevel.epoch);
  });
